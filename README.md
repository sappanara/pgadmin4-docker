...
```bash
$ docker run --rm -p 5050:5050 strakhov/pgadmin4
```
...
$ docker run -d -p 5050:5050 --name pgadmin --net pg strakhov/pgadmin4
```
...
```bash
$ docker run -d -p 5050:5050 -v /Users/me/pgadmin:/pgadmin strakhov/pgadmin4
```
...
```bash
$ docker run -d -p 5050:5050 --name pgadmin --read-only strakhov/pgadmin4
```
...
https://github.com/strakhov/pgadmin4
